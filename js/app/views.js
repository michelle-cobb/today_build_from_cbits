...
app.views.lessonFinishButton = function(label){
        return '<a href="#/""><input type="button" class="btn" value="'+label+'" style="float:right; min-width: 28%;margin-top: 26px;margin-right: -18px;" name="lessonFinishButton"/></a>'
}
