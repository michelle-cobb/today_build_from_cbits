...
function practicalFeedbackModal(pracObject) {
	...
	switch(true) {
		...
		case (pracObject.satisfiedPrac == true && pracObject.supportPrac !== "Very much" && pracObject.numPrac != "Variety"):
		...
		case (pracObject.satisfiedPrac == false && pracObject.supportPrac !== "Very much" && pracObject.numPrac !="Variety"):
...
function emotionalFeedbackModal(emotObject) {
	...
	switch(true) {
		...
		case (emotObject.satisfiedEmot == true && emotObject.supportEmot !== "Very much" && emotObject.numEmot != "Variety"):
		...
		case (emotObject.satisfiedEmot == false && emotObject.supportEmot !== "Very much" && emotObject.numEmot !="Variety"):
...
function belongingFeedbackModal(belongObject) {
	...
	switch(true) {
		...
		case (belongObject.satisfiedBelong == true && belongObject.supportBelong !== "Very much" && belongObject.numBelong != "Variety"):
		...
		case (belongObject.satisfiedBelong == false && belongObject.supportBelong !== "Very much" && belongObject.numBelong !="Variety"):
		...
		case (belongObject.satisfiedBelong == false && belongObject.supportBelong == "Very much" && belongObject.numBelong != "Variety"):
			...
			html+= "<p>Consider who you might be able to build a relationship with that might offer another source of practical support. Having a larger support network may help you feel more satisfied. Being able to receive practical support when you need it is important!</p>";
